...
<html>
    ...
    <body>
        ...
        <label for="teacherID">Teacher ID</label>
          ...
          <input type="text" name="teacherphone"><br>
          <label for="teacherEmail">Teacher Email</label>
          <input type="text" name="teacherEmail"><br>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO teacher (tid,tname,tphone,temail) VALUES ('$teacherID','$teacherName','$teacherphone','$teacherEmail')";
