...
<html>
    ...
    <body>
        ...
        <form method="post">
          ...
          <label for="parentname">Parent Name:<select name="pname"><?php
            $link = mysqli_connect("localhost", "root", "", "school");
            if ($link === false) {
                die("Connection failed: " . mysqli_connect_error());
            }
            $sql = "SELECT pname FROM parent";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<option value=''>No Parents Name found</option>";
            }
            mysqli_close($link);
            ?></select></label><br>
          <label for="classID">Class ID:<select name="classID">
          <?php
            $link = mysqli_connect("localhost", "root", "", "school");
            if ($link === false) {
                die("Connection failed: " . mysqli_connect_error());
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<option value=''>No Class ID found</option>";
            }
            mysqli_close($link);
            ?>
          </select></label><br>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO student (sid,sname,sphone,semail,saddress,pname,cid) VALUES ('$studentID','$studentName','$studentphone','$studentEmail',
    '$studentaddress','$pname','$classID')";
