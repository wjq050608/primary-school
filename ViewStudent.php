...
<h3>See all students</h3>
		...
		<table>
			...
			<tr>
                ...
                <th width="250px">Student phone<br><hr></th>
                <th width="250px">Student Email<br><hr></th>
			...
			<?php
			 $sql = mysqli_query($link, "SELECT sid,sname,sphone,semail,saddress,
            pname,cid FROM student");
