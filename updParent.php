    ...
    <body>
       ...
       if ($link === false) {
           die("Connection failed: ");
			 ...
			 $sql = mysqli_query($link, "SELECT pname,paddress,pphone,pemail
            FROM parent");
          ...
          <input type='text' name='paddress' value='{$row['paddress']}'><br>
          <label for='pphone'>Parent phone</label>
          <input type='text' name='pphone' value='{$row['pphone']}'><br>
          <label for='pemail'>Parent Email</label>
          <input type='text' name='pemail' value='{$row['pemail']}'><br>
...
if (isset($_POST['submit'])) {
    ...
    $pphone = $_POST['pphone'];
    $pemail = $_POST['pemail'];
    $sql = "UPDATE parent SET paddress='$paddress', pphone='$pphone', pemail='$pemail' WHERE pname=$pname";
